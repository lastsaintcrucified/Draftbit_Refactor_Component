...
export const createAccessibleProp = (overrides = {}) => ({
    label: "Accessible",
    description: "When set to true, indicates that the element is an accessibility element. ",
...
export const createAccessibilityLabelProp = (overrides = {}) => ({
    ...
    description: "The text that's read by the screen reader when the user interacts with the element.",
    group: GROUPS.accessibility,
    editable: true,
    required: false,
    formType: FORM_TYPES.string,
